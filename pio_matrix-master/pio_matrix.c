...
// vetor para desligar toda a matriz de leds - 1
...
// vetor para acender toda a matriz de leds - 2
...
void desenho_pio(double *desenho, uint32_t valor_led, PIO pio, uint sm, double r, double g, double b)
{
    ...
    {
        valor_led = matrix_rgb(desenho[i], r = 0.0, g = 0.0);
...
int main()
{
    ...
    gpio_set_irq_enabled_with_callback(TECLA_ESTRELA, GPIO_IRQ_EDGE_FALL, 1, &gpio_irq_handler);
